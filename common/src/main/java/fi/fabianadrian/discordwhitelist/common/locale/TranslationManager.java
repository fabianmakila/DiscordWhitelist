package fi.fabianadrian.discordwhitelist.common.locale;
...
public final class TranslationManager {
	...
	public TranslationManager(Logger logger, Path localeDirectoryPath, Key key) {
		this.logger = logger;
	...
	public void load() {
		...
		this.store = MiniMessageTranslationStore.create(this.key);
